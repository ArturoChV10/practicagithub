...
public:
    vector<News *> getRecords()
    {
        ...
        string url = "https://newsapi.org/v2/everything?q=election&from=2023-08-29&sortBy=popularity&apiKey=3504ea315bc8470a8fe1bd7c03723b4d";
...
int main(void)
{
    ...
    for(int indice = 0; indice < 98; indice++) {
        cout << allrecords.at(indice)->getDescription() << endl;
    }

//    cout << allrecords.at(0)->getDescription() << endl;
